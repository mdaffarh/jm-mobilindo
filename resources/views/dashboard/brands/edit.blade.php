    ...
    <div class="p-4 pt-8 sm:ml-64">
        <div class="p-4 border-2 border-dark-orange border-dashed rounded-lg mt-14 font-sans ">
            <section class="mt-4 mb-6 text-center">
                <span class="text-4xl font-bold font-clash text-dark-orange">Edit Data Merk</span>
            </section>
            <section>
                <form class="max-w-2xl mx-auto" enctype="multipart/form-data" method="POST"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            placeholder="Toyota" value="{{ old('name', $brand->name) }}" required />
                    </div>
                    <div class="mb-5">
                        <label for="country" class="block mb-2 text-sm font-medium text-gray-900">Asal Negara</label>
                        <input type="text" id="country" name="country"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5"
                            placeholder="Jepang" value="{{ old('country', $brand->country) }}" required />
                    </div>
                    <div class="mb-5">
                        <label for="logo" class="block mb-2 text-sm font-medium text-gray-900">Logo Brand</label>
                        <div class="mb-2">
                            @if ($brand->image_path)
                                <img id="imagePreview" src="{{ asset('storage/' . $brand->image_path) }}" alt="Preview"
                                    class="w-1/2 h-1/2 object-contain border border-gray-300 rounded-lg">
                            @else
                    ...
                    <button type="submit"
                        class="text-white bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center cursor-pointer">Update
                        Data</button>
