...
@section('content')
    <div class="p-4 pt-8 sm:ml-64">
        <div class="p-4 border-2 border-dark-orange border-dashed rounded-lg mt-14">
            <section class="mt-4 mb-6">
                <span class="text-4xl font-bold font-clash text-dark-orange">Dashboard JM Mobilindo</span>
            </section>
